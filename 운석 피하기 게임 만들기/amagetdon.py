...
class Spaceship(pygame.sprite.Sprite):
    def __init__(self):
        ...
        spaceship_image_path = resource_path('운석 피하기 게임 만들기/assets/spaceship.png')
        explosion_image_path = resource_path('운석 피하기 게임 만들기/assets/explosion.png')
        explosion_sound_path = resource_path('운석 피하기 게임 만들기/assets/explosion.wav')
...
class Rock(pygame.sprite.Sprite):
    def __init__(self, xpos, ypos, hspeed, vspeed):
        ...
        rock_images_path = resource_path('운석 피하기 게임 만들기/assets/rock')
        image_file_list = os.listdir(rock_images_path)
        self.image_path_lsit = [os.path.join(rock_images_path, file) for file in image_file_list if file.endswith(".png")]
        choice_rock_path = random.choice(self.image_path_lsit)
...
class Warp(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load(resource_path('운석 피하기 게임 만들기/assets/warp.png'))
        self.rect = self.image.get_rect()
...
class Game():
    def __init__(self):
        self.menu_image = pygame.image.load(resource_path('운석 피하기 게임 만들기/assets/game_screen.png'))
        self.background_img = pygame.image.load(resource_path('운석 피하기 게임 만들기/assets/background.jpg'))
        self.font_70 = pygame.font.Font(resource_path('운석 피하기 게임 만들기/assets/NanumGothic.ttf'), 70)
        self.font_30 = pygame.font.Font(resource_path('운석 피하기 게임 만들기/assets/NanumGothic.ttf'), 30)
        self.warp_sound = pygame.mixer.Sound(resource_path('운석 피하기 게임 만들기/assets/warp.wav'))
        pygame.mixer.music.load(resource_path('운석 피하기 게임 만들기/assets/Inner_Sanctum.mp3'))
    ...
    def run_logic(self, screen):
        ...
        if random.randint(1, self.occur_prob) == 1:
            ...
            if random.randint(1, self.occur_prob * 10) == 1:
                warp = Warp(random.randint(30, SCREEN_WIDTH - 30), random.randint(30, SCREEN_HEIGHT - 30))
                self.warps.add(warp)
    ...
    def display_menu(self, screen):
        ...
        self.draw_text(screen, '우주 운석 피하기', self.font_70, draw_x, draw_y, WHITE)
        self.draw_text(screen, '점수: {}'.format(self.score), self.font_30, draw_x, draw_y + 100, YELLOW)
        self.draw_text(screen, '마우스 버튼을 누르면 게임이 시작됩니다.', self.font_30, draw_x, draw_y + 180, WHITE)
