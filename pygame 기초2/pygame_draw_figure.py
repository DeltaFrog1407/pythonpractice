...
def main():
    ...
    while True:
        ...
        pygame.draw.lines(screen, BLUE, True, [[50, 300], [150,400], [50, 500]])
        pygame.draw.rect(screen, RED, [200, 50, 120, 80], 2)
        pygame.draw.rect(screen, GREEN, [200, 200, 60, 180])
        pygame.draw.polygon(screen, BLUE, [[250, 400], [200, 500], [300, 500]], 10)
        pygame.draw.circle(screen, GOLD, [400, 100], 80)
        pygame.draw.ellipse(screen, SILVER, [400-80, 300-40, 160, 80], 20)
