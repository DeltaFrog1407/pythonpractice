...
class Car():
    def __init__(self, x=0, y=0, dx=0, dy=0):
        ...
        car_images_path = resource_path('레이싱 게임 만들기/assets/car')
        ...
        crash_image_path = resource_path('레이싱 게임 만들기/assets/crash.png')
        crash_sound_path = resource_path('레이싱 게임 만들기/assets/crash.wav')
        collision_sound_path = resource_path('레이싱 게임 만들기/assets/collision.wav')
        engine_sound_path = resource_path('레이싱 게임 만들기/assets/engine.wav')
...
class Game():
    def __init__(self):
        menu_image_path = resource_path('레이싱 게임 만들기/assets/menu_car.png')
        self.imgae_intro = pygame.image.load(menu_image_path)
        pygame.mixer.music.load(resource_path('레이싱 게임 만들기/assets/race.wav'))
        font_path = resource_path('레이싱 게임 만들기/assets/NanumGothicCoding-Bold.ttf')
    ...
    def display_menu(self, screen):
        screen.fill(GRAY)
        screen.blit(self.imgae_intro, [40, 150])
        draw_x = int(SCREEN_WIDTH / 2)
        draw_y = int(SCREEN_HEIGHT / 2)
        self.draw_text(screen, "PyCar : Racing Game", self.font_40, draw_x, draw_y + 50, BLACK)
        self.draw_text(screen, "Score: " + str(self.score), self.font_40, draw_x, draw_y + 150, WHITE)
        self.draw_text(screen, "Press Space Key to Start", self.font_30, draw_x, draw_y + 200, RED)
