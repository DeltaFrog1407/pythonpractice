...
def game_main():
    global index, timer, score, hisc, difficulty, nextcat
    global cursor_x, cursor_y, mouse_c
    if index == 0:
        draw_txt("고양이", 312, 240, 100, "violet", "TITLE")
        ...
        if sc > 0:
            ...
            if over_neko() == False:
                nextcat = random.randint(1, difficulty)
                index = 5
            else:
                index = 6
                timer = 0
        ...
        if 24 <= mouse_x and mouse_x < 24+72*8 and 24 <= mouse_y and mouse_y < 24+72*10:
            ...
            if mouse_c == 1:
                mouse_c = 0
                set_neko()
                neko[cursor_y][cursor_x] = nextcat
                nextcat = 0
                index = 2
        cvs.delete("CURSOR")
    ...
    if nextcat > 0:
        cvs.create_image(752, 128, image=img_neko[nextcat], tag="INFO")
