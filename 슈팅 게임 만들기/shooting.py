...
class Fighter(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load(resource_path('슈팅 게임 만들기/assets/fighter.png'))
...
class Missile(pygame.sprite.Sprite):
    def __init__(self, xpos, ypos, speed):
        ...
        self.image = pygame.image.load(resource_path('슈팅 게임 만들기/assets/missile.png'))
        self.sound = pygame.mixer.Sound(resource_path('슈팅 게임 만들기/assets/missile.wav'))
        self.rect = self.image.get_rect()
        self.rect.x = xpos
        self.rect.y = ypos
        self.speed = speed
...
class Rock(pygame.sprite.Sprite):
    def __init__(self, xpos, ypos, speed):
        ...
        rock_images_path = resource_path('슈팅 게임 만들기/assets/rock')
...
class Game():
    def __init__(self):
        self.menu_image = pygame.image.load(resource_path('슈팅 게임 만들기/assets/background.png'))
        self.background_image = pygame.image.load(resource_path('슈팅 게임 만들기/assets/background.png'))
        self.explosion_image = pygame.image.load(resource_path('슈팅 게임 만들기/assets/explosion.png'))
        self.default_font = pygame.font.Font(resource_path('슈팅 게임 만들기/assets/NanumGothic.ttf'), 28)
        self.font_70 = pygame.font.Font(resource_path('슈팅 게임 만들기/assets/NanumGothic.ttf'), 70)
        self.font_30 = pygame.font.Font(resource_path('슈팅 게임 만들기/assets/NanumGothic.ttf'), 30)
        explosion_file = ('슈팅 게임 만들기/assets/explosion01.wav',
                          '슈팅 게임 만들기/assets/explosion02.wav',
                          '슈팅 게임 만들기/assets/explosion03.wav')
        self.explosion_path_list = [resource_path(file) for file in explosion_file]
        self.gameover_sound = pygame.mixer.Sound(resource_path('슈팅 게임 만들기/assets/gameover.wav'))
        pygame.mixer.music.load(resource_path('슈팅 게임 만들기/assets/music.wav'))
    ...
    def display_menu(self, screen):
        ...
        self.draw_text(screen, "운석을 막아라!", self.font_70, draw_x, draw_y, YELLOW)
        self.draw_text(screen, "스페이스 키를 누르면", self.font_30, draw_x, draw_y + 200, WHITE)
        self.draw_text(screen, "게임이 시작됩니다.", self.font_30, draw_x, draw_y + 250, WHITE)
        
    def display_frame(self, screen):
        screen.blit(self.background_image, self.background_image.get_rect())
        self.draw_text(screen, '파괴한 운석: {}'.format(self.shot_count), self.default_font, 100, 20, YELLOW)
        self.draw_text(screen, '놓친 운석: {}'.format(self.count_missed), self.default_font, 400, 20, RED)
        self.rocks.update()
