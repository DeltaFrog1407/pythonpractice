...
def save_load():
    global idx, tmr, floor, fl_max, pl_x, pl_y, pl_lifemax
    global pl_life, pl_str, food, potion, blazegem
...
dungeon = []
if save_check() == True:
    with open("save2.pkl", "rb") as h:
        dungeon = pickle.load(h)
else:
